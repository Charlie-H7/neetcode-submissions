class Solution {
    ...
    lengthOfLongestSubstring(s: string): number {
        ...
        while(r < s.length){
            ...
            if(charSet.has(s[r])){ // If there is a dupe (i dont think this is really needed now that i think about it lol, I think the while loop has that handled already)
